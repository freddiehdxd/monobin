...
// Registry of available islands. Add components here as you create them. An
// island referenced in a template but missing here won't mount — `monobin check`
// flags that.
const islands = {
  Counter,
};
...
// render() (not hydrate()) is the correct API. Each mount is isolated so one
// failing island can't take down the rest of the page.
